...
const customFunction = (param1, param2) => `The first parameter is ${param1}. The second parameter is ${param2}.`;



// INVOKE THE FUNCTION HERE. THE PARAMETERS TAKE ANY DATATYPE.

console.log(customFunction(`you`, `I`));
...
const createName = (fullName) => console.log(`Hello, my full name is ${fullName}`) 
// INVOKE 'GREETING FUNCTION' HERE

greeting(`Tyler`, `Aycock`, createName)
...
// CODE HERE
console.log(pricePlusTax(prices, addingUp));
